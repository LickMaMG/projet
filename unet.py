...
def unet_model(input_shape, filters_init=32, dropout=0.5, activation='relu', output_activation='relu'):
    ...
    # Decoder
    up6 = Conv2D(filters_init*8, 2, activation=activation,
    ...
    up7 = Conv2D(filters_init*4, 2, activation=activation,
    ...
    up8 = Conv2D(filters_init*2, 2, activation=activation,
    ...
    up9 = Conv2D(filters_init, 2, activation=activation, padding='same')(
...
def unet_model2(input_shape, filters_init=32, dropout=0.5, activation='relu', output_activation='relu'):
    inputs = Input(input_shape)
...
def unet_model3(input_shape, use_batch_norm, activation, output_activation, dropout=0.5):
    inputs = Input(input_shape)
